...
const Features = () => {
    ...
    useGSAP(()=>{
        ...
        animateWithGsap('.g_grow', { scale:1 , opacity:1 , ease: 'power1'}, {scrup : 5.5});
  ...
  return (
    <section className='relative h-full overflow-auto common-padding bg-zinc'>
        <div className="screen-max-width">
            ...
            <div className="flex flex-col items-center justify-center overflow-hidden">
                ...
                <div className="flex-col flex-center sm:px-10">
                    <div className="relative h-[50vh] flex items-start w-full">
                        <video playsInline id='exploreVideo' className='object-cover object-center w-full h-full' prefix='none' muted autoPlay ref={videoRef} src={exploreVideo} type = "video/mp4"></video>
                    </div>
